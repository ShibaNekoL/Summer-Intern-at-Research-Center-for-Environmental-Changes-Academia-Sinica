...
file.path <- list.files("C:/Users/司波達也/OneDrive/桌面 1/RCEC", 
                        pattern = ".txt", 
                        full.names = T)
...
# ### plot
# w <- wbgt_in $ WBGT_out....
# f <- func.fWBGTo(Ta, Tg, Td, WS, SR, RH, Tnwb)
# plot(f, w,main = "Estimation of WBGT",xlab = "Prediction by R", ylab = "Prediction by Excel", xlim = c(10, 35), ylim = c(10, 35))
# model <- lm(w~f)
...
# 
# 
# plot(Tnwb, wbgt_in $ Calculated.Wet.Bulb.Temperature.... ,main = "Estimation of Twb",xlab = "Prediction by R", ylab = "Prediction by Excel", xlim = c(5, 30), ylim = c(5, 30))
# model <- lm(wbgt_in $ Calculated.Wet.Bulb.Temperature.... ~Tnwb)
# abline(model, col="blue", lwd=1)
# abline(0, 1, col="red", lwd=1)
# summary(model)
# 
# plot(Tg, wbgt_in $ Calculated.Globe.Temperature.... ,main = "Estimation of Tg",xlab = "Prediction by R", ylab = "Prediction by Excel", xlim = c(15, 45), ylim = c(15, 45))
# model <- lm(wbgt_in $ Calculated.Globe.Temperature.... ~Tg)
# abline(model, col="blue", lwd=1)
# abline(0, 1, col="red", lwd=1)
# summary(model)
